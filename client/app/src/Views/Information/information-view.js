        ...
        <div className="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-12">
            <div className="panel panel-default panel-transparent">
                ...
                <div className="panel-body">
                    ...
                    <p className="news-text">Rosters will be locked from Wednesday at 4pm PDT - Saturday at 8pm PDT
                    (Sunday on finals week).</p>

                    <p className="news-text">You will not be able to switch out any players until the roster unlocks again.
                    All of your players award you points for every game they play.</p>
                    <p className="news-text"> You many add any player to your roster. There will be weekly, stage, and seasonal leaderboards.</p>
                </div>
                <div className="panel-body">
                    <h2>Global League Scoring</h2>
                    <p className="news-text">You will receive a certain number of points when any one of your players performs
                    ...
                    <p className="news-text">In other words, a mercy will recieve more points for a final
                    ...
                    <p className="news-text">There will soon
                ...
                <div className="panel-body">
                    ...
                    <p className="news-text">This is where the real fun comes in. Live drafts, trades, auctions, subs, chat, etc. Coming soon...</p>
                </div>
            </div>
        </div>
    </div>
